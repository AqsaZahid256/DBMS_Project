namespace ProjectB
{
	partial class AssessmentResult
	{
		...
		private void InitializeComponent()
		{
			...
			this.DataTable1TableAdapter = new ProjectB.AssessmentdatasetTableAdapters.DataTable1TableAdapter();
			...
			this.reportViewer1.LocalReport.ReportEmbeddedResource = "ProjectB.Report1.rdlc";
			...
			this.DataTable1BindingSource.DataSource = this.Assessmentdataset;
			// 
		...
		private AssessmentdatasetTableAdapters.DataTable1TableAdapter DataTable1TableAdapter;
	}
}